//
//  LTxSipprMsgTypeTableViewCell.m
...
@interface LTxSipprMsgTypeTableViewCell()
...
@implementation LTxSipprMsgTypeTableViewCell
...
-(void)setModel:(LTxSipprMsgTypeModel *)model{
    _model = model;
    if (model) {
