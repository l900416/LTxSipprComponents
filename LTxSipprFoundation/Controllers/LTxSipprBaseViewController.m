...
@interface LTxSipprBaseViewController ()<DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>

@property (strong, nonatomic) UIActivityIndicatorView *activityView;
@property (nonatomic, copy) UIScrollView* refreshScrollView;

@property (nonatomic, copy) LTxSipprCallbackBlock refreshAction;

@end

@implementation LTxSipprBaseViewController
...
-(void)setupViewConfig{
    ...
    self.view.backgroundColor = [LTxSipprConfig sharedInstance].viewBackgroundColor;
...
-(void)setupLeftBackButton{
    ...
    [backBtn setImage:[UIImage imageWithContentsOfFile: [[NSBundle bundleForClass:self.class] pathForResource:@"LTxComponentsForSippr.bundle/Images/ic_navi_back" ofType:@"png"]] forState:UIControlStateNormal];
...
-(void)setupActivityView{
    ...
    _activityView.backgroundColor = [LTxSipprConfig sharedInstance].activityViewBackgroundColor;
...
-(LTxSipprRefreshHeader*)headerWithRefreshingBlock:(LTxSipprCallbackBlock)pullDownRefresh{
    LTxSipprRefreshHeader *header = [LTxSipprRefreshHeader headerWithRefreshingBlock:^{
...
-(LTxSipprRefreshFooter*)footerWithRefreshingBlock:(LTxSipprCallbackBlock)pullUpRefresh{
    LTxSipprRefreshFooter *footer = [LTxSipprRefreshFooter footerWithRefreshingBlock:^{
...
//    NSString *text;
//    NSMutableDictionary *attributes = [NSMutableDictionary new];
//    [attributes setObject:[UIFont systemFontOfSize:15.0] forKey:NSFontAttributeName];
//
//    if (_errorTips == nil) {
//        text = @"";
