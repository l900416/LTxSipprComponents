...
-(UIButton*)dismissBtn{
    if (!_dismissBtn) {
        ...
        [_dismissBtn setImage:LTxSipprBundlePngImageWithName(@"ic_camera_action_dismiss") forState:UIControlStateNormal];
...
-(UIButton*)cancelBtn{
    if (!_cancelBtn) {
        ...
        [_cancelBtn setImage:LTxSipprBundlePngImageWithName(@"ic_camera_action_cancel") forState:UIControlStateNormal];
...
-(UIButton*)doneBtn{
    if (!_doneBtn) {
        ...
        [_doneBtn setImage:LTxSipprBundlePngImageWithName(@"ic_camera_action_done") forState:UIControlStateNormal];
