...
@interface LTxSipprCameraShootToolView()<CAAnimationDelegate, UIGestureRecognizerDelegate>
...
@implementation LTxSipprCameraShootToolView
...
-(UIButton*)dismissBtn{
    if (!_dismissBtn) {
        ...
        [_dismissBtn setImage:[UIImage imageNamed:LTxSipprBundleImagePath(@"ic_camera_action_dismiss")] forState:UIControlStateNormal];
...
-(UIButton*)cancelBtn{
    if (!_cancelBtn) {
        ...
        [_cancelBtn setImage:[UIImage imageNamed:LTxSipprBundleImagePath(@"ic_camera_action_cancel")] forState:UIControlStateNormal];
...
-(UIButton*)doneBtn{
    if (!_doneBtn) {
        ...
        [_doneBtn setImage:[UIImage imageNamed:LTxSipprBundleImagePath(@"ic_camera_action_done")] forState:UIControlStateNormal];
