...
@protocol LTxSipprCameraShootToolDelegate <NSObject>
 ...
 * 取消和确定按钮
 **/
@interface LTxSipprCameraShootToolView : UIView

@property (nonatomic, weak) id  <LTxSipprCameraShootToolDelegate> delegate;
